...
export type GetLessonQueryBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonQueryBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', id: string, title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };
...
export const GetLessonQueryBySlugDocument = gql`
...
/**
 * __useGetLessonQueryBySlugQuery__
 *
 * To run a query within a React component, call `useGetLessonQueryBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonQueryBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonQueryBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonQueryBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonQueryBySlugQuery, GetLessonQueryBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonQueryBySlugQuery, GetLessonQueryBySlugQueryVariables>(GetLessonQueryBySlugDocument, options);
      }
export function useGetLessonQueryBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonQueryBySlugQuery, GetLessonQueryBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonQueryBySlugQuery, GetLessonQueryBySlugQueryVariables>(GetLessonQueryBySlugDocument, options);
        }
export type GetLessonQueryBySlugQueryHookResult = ReturnType<typeof useGetLessonQueryBySlugQuery>;
export type GetLessonQueryBySlugLazyQueryHookResult = ReturnType<typeof useGetLessonQueryBySlugLazyQuery>;
export type GetLessonQueryBySlugQueryResult = Apollo.QueryResult<GetLessonQueryBySlugQuery, GetLessonQueryBySlugQueryVariables>;
